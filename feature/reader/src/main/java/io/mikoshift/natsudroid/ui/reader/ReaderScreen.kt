...
import io.mikoshift.natsudroid.core.ui.CollectEffects
import io.mikoshift.natsudroid.feature.reader.R
import io.mikoshift.natsudroid.ui.reader.components.BlockContent
import io.mikoshift.natsudroid.ui.reader.components.DictionaryLookupSheet
import io.mikoshift.natsudroid.ui.reader.components.ReaderSettingsSheet
import io.mikoshift.natsudroid.ui.reader.components.TocSheet
...
internal fun ReaderScreenContent(
    ...
    onThemeChange: (io.mikoshift.natsudroid.core.model.ReaderTheme) -> Unit,
    onFuriganaModeChange: (io.mikoshift.natsudroid.core.model.FuriganaMode) -> Unit,
            ...
            uiState = ReaderUiState(
                ...
                blocks = listOf(
                    ReaderBlockItem(
                        ...
                        sectionId = "section-0",
                        blockIndex = 0,
                        block = io.mikoshift.natsudroid.core.model.content.ParagraphBlock(
                            id = "b0",
                            text = "Hello reader.",
                        ),
                    ),
