...
class NatsudroidDatabaseMigrationTest {
    @get:Rule
    val helper =
        MigrationTestHelper(
    ...
    fun migrate2To3_preservesDocumentsProgressOutboxAndSyncCursor() {
        ...
        val db =
            helper.runMigrationsAndValidate(
                ...
                3,
                true,
                NatsudroidDatabaseMigrations.MIGRATION_2_3,
            )
    ...
    fun migrate3To4_addsIdempotencyKeyToOutbox() {
        ...
        val db =
            helper.runMigrationsAndValidate(
                ...
                4,
                true,
                NatsudroidDatabaseMigrations.MIGRATION_3_4,
            )
    ...
    fun migrate1To2_splitsEmbeddedDocumentFieldsIntoDedicatedTables() {
        ...
        val db =
            helper.runMigrationsAndValidate(
                ...
                2,
                true,
                NatsudroidDatabaseMigrations.MIGRATION_1_2,
            )
